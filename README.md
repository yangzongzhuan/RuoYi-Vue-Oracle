...
* 本仓库为RuoYi-Vue-Oracle的Spring Boot 3 的版本，保持同步更新。
...
| 名称              | 说明                      | 地址                                                                 |
| :---------------- | :------------------------ | :------------------------------------------------------------------- |
| master 默认分支   | Spring Boot 4.x (JDK 17+) | https://gitcode.com/yangzongzhuan/RuoYi-Vue-Oracle                   |
| springboot3 分支  | Spring Boot 3.x (JDK 17+) | https://gitcode.com/yangzongzhuan/RuoYi-Vue-Oracle/tree/springboot3  |
| springboot2 分支  | Spring Boot 2.x (JDK 8+)  | https://gitcode.com/yangzongzhuan/RuoYi-Vue-Oracle/tree/springboot2  |  
